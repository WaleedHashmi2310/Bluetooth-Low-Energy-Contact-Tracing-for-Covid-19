                            ...
                            Container(
                                ...
                                child: RichText(
                                  ...
                                  text: const TextSpan(children: <TextSpan>[
                                    TextSpan(text: 'We will send you a ', style: TextStyle(color: MyColors.primaryColor, fontSize: 16)),
                                    TextSpan(
                                        text: 'One Time Password\n', style: TextStyle(color: MyColors.primaryColor, fontSize: 16, fontWeight: FontWeight.bold)),
                                    TextSpan(text: 'on this mobile number', style: TextStyle(color: MyColors.primaryColor,fontSize: 16)),
                                  ]),
                                )),
                            Container(
                              height: 40,
                              ...
                              child: RaisedButton(
                                onPressed: () {
                                  if (phoneController.text.isNotEmpty) {
                                    ...
                                    loginStore.loginScaffoldKey.currentState.showSnackBar(const SnackBar(
